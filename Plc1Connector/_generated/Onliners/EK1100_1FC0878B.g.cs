...
#pragma warning disable SA1402, CS1591, CS0108, CS0067
	[Vortex.Connector.Attributes.TypeMetaDescriptorAttribute("{attribute addProperty VendorId \"#x00000002\" } {attribute addProperty BoxType \"EK1100-0000-0018\" } {attribute addProperty Description \"EK1100 EtherCAT Coupler (2A E-Bus)\" } {attribute addProperty Physics \"YKY\" } {attribute addProperty Id \"InfoDataAT %I*InfoData_6F19DB2B2\" } {attribute addProperty CRC \"532711307\" } {attribute addProperty Size \"2\" } {attribute addProperty Name \"\" }", "EK1100_1FC0878B", "Plc1", TypeComplexityEnum.Complex)]
	public partial class EK1100_1FC0878B : TcoIo.EtcSlaveBoxBase_77A0E4A7, Vortex.Connector.IVortexObject, IEK1100_1FC0878B, IShadowEK1100_1FC0878B, Vortex.Connector.IVortexOnlineObject, Vortex.Connector.IVortexShadowObject
	{
		...
		TcoIo.IInfoData_6F19DB2B IEK1100_1FC0878B.InfoData
		{
			get
			{
				return InfoData;
		...
		TcoIo.IShadowInfoData_6F19DB2B IShadowEK1100_1FC0878B.InfoData
		{
			get
			{
				return InfoData;
		...
		public new PlainEK1100_1FC0878B CreatePlainerType()
		{
			var cloned = new PlainEK1100_1FC0878B();
			base.CreatePlainerType(cloned);
			cloned.InfoData = InfoData.CreatePlainerType();
			return cloned;
		}

		protected PlainEK1100_1FC0878B CreatePlainerType(PlainEK1100_1FC0878B cloned)
		{
			base.CreatePlainerType(cloned);
			cloned.InfoData = InfoData.CreatePlainerType();
			return cloned;
		...
		public void FlushPlainToOnline(Plc1.PlainEK1100_1FC0878B source)
		{
			source.CopyPlainToCyclic(this);
			this.Write();
		}

		public void CopyPlainToShadow(Plc1.PlainEK1100_1FC0878B source)
		{
		...
		public void FlushOnlineToPlain(Plc1.PlainEK1100_1FC0878B source)
		{
			this.Read();
		...
		public EK1100_1FC0878B(Vortex.Connector.IVortexObject parent, string readableTail, string symbolTail): base (parent, readableTail, symbolTail)
		{
			...
			AttributeDescription = "EK1100 EtherCAT Coupler (2A E-Bus)";
			AttributePhysics = "YKY";
		...
		public EK1100_1FC0878B(): base ()
		{
            ...
            /// </summary>
            /// <exclude />
	public partial class PlainEK1100_1FC0878B
	{
		public void CopyPlainToCyclic(Plc1.EK1100_1FC0878B target)
		{
			base.CopyPlainToCyclic(target);
			InfoData.CopyPlainToCyclic(target.InfoData);
		}

		public void CopyPlainToCyclic(Plc1.IEK1100_1FC0878B target)
		{
			this.CopyPlainToCyclic((Plc1.EK1100_1FC0878B)target);
		}

		public void CopyPlainToShadow(Plc1.EK1100_1FC0878B target)
		{
			base.CopyPlainToShadow(target);
			InfoData.CopyPlainToShadow(target.InfoData);
		}

		public void CopyPlainToShadow(Plc1.IShadowEK1100_1FC0878B target)
		{
			this.CopyPlainToShadow((Plc1.EK1100_1FC0878B)target);
		}

		public void CopyCyclicToPlain(Plc1.EK1100_1FC0878B source)
		{
			base.CopyCyclicToPlain(source);
			InfoData.CopyCyclicToPlain(source.InfoData);
		}

		public void CopyCyclicToPlain(Plc1.IEK1100_1FC0878B source)
		{
			this.CopyCyclicToPlain((Plc1.EK1100_1FC0878B)source);
		}

		public void CopyShadowToPlain(Plc1.EK1100_1FC0878B source)
		{
			base.CopyShadowToPlain(source);
			InfoData.CopyShadowToPlain(source.InfoData);
		}

		public void CopyShadowToPlain(Plc1.IShadowEK1100_1FC0878B source)
		{
			this.CopyShadowToPlain((Plc1.EK1100_1FC0878B)source);
		}
	}
}