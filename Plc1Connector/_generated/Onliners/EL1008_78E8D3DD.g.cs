...
#pragma warning disable SA1402, CS1591, CS0108, CS0067
	[Vortex.Connector.Attributes.TypeMetaDescriptorAttribute("{attribute addProperty VendorId \"#x00000002\" } {attribute addProperty BoxType \"EL1008-0000-0018\" } {attribute addProperty Description \"EL1008 8Ch. Dig. Input 24V, 3ms\" } {attribute addProperty Physics \"KK\" } {attribute addProperty Id \"Channel_1AT %I*Channel_830843C11Channel_2AT %I*Channel_830843C11Channel_3AT %I*Channel_830843C11Channel_4AT %I*Channel_830843C11Channel_5AT %I*Channel_830843C11Channel_6AT %I*Channel_830843C11Channel_7AT %I*Channel_830843C11Channel_8AT %I*Channel_830843C11WcStateAT %I*WcState_9091E0EB2InfoDataAT %I*InfoData_6F19DB2B2\" } {attribute addProperty CRC \"2028524509\" } {attribute addProperty Size \"12\" } {attribute addProperty Name \"\" }", "EL1008_78E8D3DD", "Plc1", TypeComplexityEnum.Complex)]
	public partial class EL1008_78E8D3DD : TcoIo.EtcSlaveTerminalBase_947E5A46, Vortex.Connector.IVortexObject, IEL1008_78E8D3DD, IShadowEL1008_78E8D3DD, Vortex.Connector.IVortexOnlineObject, Vortex.Connector.IVortexShadowObject
	{
		...
		IChannel_830843C1 IEL1008_78E8D3DD.Channel_1
		{
			get
			{
				return Channel_1;
		...
		IShadowChannel_830843C1 IShadowEL1008_78E8D3DD.Channel_1
		{
			get
			{
				return Channel_1;
		...
		IChannel_830843C1 IEL1008_78E8D3DD.Channel_2
		{
			get
			{
				return Channel_2;
		...
		IShadowChannel_830843C1 IShadowEL1008_78E8D3DD.Channel_2
		{
			get
			{
				return Channel_2;
		...
		IChannel_830843C1 IEL1008_78E8D3DD.Channel_3
		{
			get
			{
				return Channel_3;
		...
		IShadowChannel_830843C1 IShadowEL1008_78E8D3DD.Channel_3
		{
			get
			{
				return Channel_3;
		...
		IChannel_830843C1 IEL1008_78E8D3DD.Channel_4
		{
			get
			{
				return Channel_4;
		...
		IShadowChannel_830843C1 IShadowEL1008_78E8D3DD.Channel_4
		{
			get
			{
				return Channel_4;
		...
		IChannel_830843C1 IEL1008_78E8D3DD.Channel_5
		{
			get
			{
				return Channel_5;
		...
		IShadowChannel_830843C1 IShadowEL1008_78E8D3DD.Channel_5
		{
			get
			{
				return Channel_5;
		...
		IChannel_830843C1 IEL1008_78E8D3DD.Channel_6
		{
			get
			{
				return Channel_6;
		...
		IShadowChannel_830843C1 IShadowEL1008_78E8D3DD.Channel_6
		{
			get
			{
				return Channel_6;
		...
		IChannel_830843C1 IEL1008_78E8D3DD.Channel_7
		{
			get
			{
				return Channel_7;
		...
		IShadowChannel_830843C1 IShadowEL1008_78E8D3DD.Channel_7
		{
			get
			{
				return Channel_7;
		...
		IChannel_830843C1 IEL1008_78E8D3DD.Channel_8
		{
			get
			{
				return Channel_8;
		...
		IShadowChannel_830843C1 IShadowEL1008_78E8D3DD.Channel_8
		{
			get
			{
				return Channel_8;
		...
		TcoIo.IWcState_9091E0EB IEL1008_78E8D3DD.WcState
		{
			get
			{
				return WcState;
		...
		TcoIo.IShadowWcState_9091E0EB IShadowEL1008_78E8D3DD.WcState
		{
			get
			{
				return WcState;
		...
		TcoIo.IInfoData_6F19DB2B IEL1008_78E8D3DD.InfoData
		{
			get
			{
				return InfoData;
		...
		TcoIo.IShadowInfoData_6F19DB2B IShadowEL1008_78E8D3DD.InfoData
		{
			get
			{
				return InfoData;
		...
		public new PlainEL1008_78E8D3DD CreatePlainerType()
		{
			var cloned = new PlainEL1008_78E8D3DD();
		...
		protected PlainEL1008_78E8D3DD CreatePlainerType(PlainEL1008_78E8D3DD cloned)
		{
			base.CreatePlainerType(cloned);
			cloned.Channel_1 = Channel_1.CreatePlainerType();
			cloned.Channel_2 = Channel_2.CreatePlainerType();
		...
		public void FlushPlainToOnline(Plc1.PlainEL1008_78E8D3DD source)
		{
			source.CopyPlainToCyclic(this);
			this.Write();
		}

		public void CopyPlainToShadow(Plc1.PlainEL1008_78E8D3DD source)
		{
		...
		public void FlushOnlineToPlain(Plc1.PlainEL1008_78E8D3DD source)
		{
			this.Read();
		...
		public EL1008_78E8D3DD(Vortex.Connector.IVortexObject parent, string readableTail, string symbolTail): base (parent, readableTail, symbolTail)
		{
			...
			AttributeBoxType = "EL1008-0000-0018";
			AttributeDescription = "EL1008 8Ch. Dig. Input 24V, 3ms";
			AttributePhysics = "KK";
			...
			AttributeCRC = "2028524509";
			AttributeSize = "12";
			PexConstructor(parent, readableTail, symbolTail);
		}

		public EL1008_78E8D3DD(): base ()
		{
            ...
            /// </summary>
            /// <exclude />
	public partial class PlainEL1008_78E8D3DD
	{
		public void CopyPlainToCyclic(Plc1.EL1008_78E8D3DD target)
		{
		...
		public void CopyPlainToCyclic(Plc1.IEL1008_78E8D3DD target)
		{
			this.CopyPlainToCyclic((Plc1.EL1008_78E8D3DD)target);
		}

		public void CopyPlainToShadow(Plc1.EL1008_78E8D3DD target)
		{
		...
		public void CopyPlainToShadow(Plc1.IShadowEL1008_78E8D3DD target)
		{
			this.CopyPlainToShadow((Plc1.EL1008_78E8D3DD)target);
		}

		public void CopyCyclicToPlain(Plc1.EL1008_78E8D3DD source)
		{
		...
		public void CopyCyclicToPlain(Plc1.IEL1008_78E8D3DD source)
		{
			this.CopyCyclicToPlain((Plc1.EL1008_78E8D3DD)source);
		}

		public void CopyShadowToPlain(Plc1.EL1008_78E8D3DD source)
		{
		...
		public void CopyShadowToPlain(Plc1.IShadowEL1008_78E8D3DD source)
		{
			this.CopyShadowToPlain((Plc1.EL1008_78E8D3DD)source);
		}
	}
}