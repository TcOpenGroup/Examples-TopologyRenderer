...
#pragma warning disable SA1402, CS1591, CS0108, CS0067
	[Vortex.Connector.Attributes.TypeMetaDescriptorAttribute("{attribute addProperty VendorId \"#x00000002\" } {attribute addProperty BoxType \"EL3024-0000-0018\" } {attribute addProperty Description \"EL3024 4Ch. Ana. Input 4-20mA DIFF\" } {attribute addProperty Physics \"KK\" } {attribute addProperty Id \"AI_Standard_Channel_1AT %I*AI_Standard_Channel_4A3944819AI_Standard_Channel_2AT %I*AI_Standard_Channel_4A3944819AI_Standard_Channel_3AT %I*AI_Standard_Channel_4A3944819AI_Standard_Channel_4AT %I*AI_Standard_Channel_4A3944819WcStateAT %I*WcState_9091E0EB2InfoDataAT %I*InfoData_23CBA8372\" } {attribute addProperty CRC \"3337055066\" } {attribute addProperty Size \"40\" } {attribute addProperty Name \"\" }", "EL3024_C6E76B5A", "Plc1", TypeComplexityEnum.Complex)]
	public partial class EL3024_C6E76B5A : TcoIo.EtcSlaveTerminalBase_947E5A46, Vortex.Connector.IVortexObject, IEL3024_C6E76B5A, IShadowEL3024_C6E76B5A, Vortex.Connector.IVortexOnlineObject, Vortex.Connector.IVortexShadowObject
	{
		AI_Standard_Channel_4A394481 _AI_Standard_Channel_1;
		...
		IAI_Standard_Channel_4A394481 IEL3024_C6E76B5A.AI_Standard_Channel_1
		{
			get
			{
		...
		IShadowAI_Standard_Channel_4A394481 IShadowEL3024_C6E76B5A.AI_Standard_Channel_1
		{
			get
			{
				return AI_Standard_Channel_1;
		...
		AI_Standard_Channel_4A394481 _AI_Standard_Channel_2;
		...
		IAI_Standard_Channel_4A394481 IEL3024_C6E76B5A.AI_Standard_Channel_2
		{
			get
			{
		...
		IShadowAI_Standard_Channel_4A394481 IShadowEL3024_C6E76B5A.AI_Standard_Channel_2
		{
			get
			{
				return AI_Standard_Channel_2;
		...
		AI_Standard_Channel_4A394481 _AI_Standard_Channel_3;
		...
		IAI_Standard_Channel_4A394481 IEL3024_C6E76B5A.AI_Standard_Channel_3
		{
			get
			{
		...
		IShadowAI_Standard_Channel_4A394481 IShadowEL3024_C6E76B5A.AI_Standard_Channel_3
		{
			get
			{
				return AI_Standard_Channel_3;
		...
		AI_Standard_Channel_4A394481 _AI_Standard_Channel_4;
		...
		IAI_Standard_Channel_4A394481 IEL3024_C6E76B5A.AI_Standard_Channel_4
		{
			get
			{
		...
		IShadowAI_Standard_Channel_4A394481 IShadowEL3024_C6E76B5A.AI_Standard_Channel_4
		{
			get
			{
				return AI_Standard_Channel_4;
		...
		TcoIo.IWcState_9091E0EB IEL3024_C6E76B5A.WcState
		{
			get
			{
				return WcState;
		...
		TcoIo.IShadowWcState_9091E0EB IShadowEL3024_C6E76B5A.WcState
		{
			get
			{
				return WcState;
		...
		TcoIo.IInfoData_23CBA837 IEL3024_C6E76B5A.InfoData
		{
			get
			{
				return InfoData;
		...
		TcoIo.IShadowInfoData_23CBA837 IShadowEL3024_C6E76B5A.InfoData
		{
			get
			{
				return InfoData;
		...
		public new PlainEL3024_C6E76B5A CreatePlainerType()
		{
			var cloned = new PlainEL3024_C6E76B5A();
		...
		protected PlainEL3024_C6E76B5A CreatePlainerType(PlainEL3024_C6E76B5A cloned)
		{
			base.CreatePlainerType(cloned);
			cloned.AI_Standard_Channel_1 = AI_Standard_Channel_1.CreatePlainerType();
			cloned.AI_Standard_Channel_2 = AI_Standard_Channel_2.CreatePlainerType();
		...
		public void FlushPlainToOnline(Plc1.PlainEL3024_C6E76B5A source)
		{
			source.CopyPlainToCyclic(this);
			this.Write();
		}

		public void CopyPlainToShadow(Plc1.PlainEL3024_C6E76B5A source)
		{
		...
		public void FlushOnlineToPlain(Plc1.PlainEL3024_C6E76B5A source)
		{
			this.Read();
		...
		public EL3024_C6E76B5A(Vortex.Connector.IVortexObject parent, string readableTail, string symbolTail): base (parent, readableTail, symbolTail)
		{
			...
			_AI_Standard_Channel_1 = new AI_Standard_Channel_4A394481(this, "AI_Standard_Channel_1", "AI_Standard_Channel_1");
			_AI_Standard_Channel_1.AttributeName = "AI_Standard_Channel_1";
			_AI_Standard_Channel_2 = new AI_Standard_Channel_4A394481(this, "AI_Standard_Channel_2", "AI_Standard_Channel_2");
			_AI_Standard_Channel_2.AttributeName = "AI_Standard_Channel_2";
			_AI_Standard_Channel_3 = new AI_Standard_Channel_4A394481(this, "AI_Standard_Channel_3", "AI_Standard_Channel_3");
			_AI_Standard_Channel_3.AttributeName = "AI_Standard_Channel_3";
			_AI_Standard_Channel_4 = new AI_Standard_Channel_4A394481(this, "AI_Standard_Channel_4", "AI_Standard_Channel_4");
			...
			AttributeBoxType = "EL3024-0000-0018";
			AttributeDescription = "EL3024 4Ch. Ana. Input 4-20mA DIFF";
			AttributePhysics = "KK";
			AttributeId = "AI_Standard_Channel_1AT %I*AI_Standard_Channel_4A3944819AI_Standard_Channel_2AT %I*AI_Standard_Channel_4A3944819AI_Standard_Channel_3AT %I*AI_Standard_Channel_4A3944819AI_Standard_Channel_4AT %I*AI_Standard_Channel_4A3944819WcStateAT %I*WcState_9091E0EB2InfoDataAT %I*InfoData_23CBA8372";
			AttributeCRC = "3337055066";
			AttributeSize = "40";
			PexConstructor(parent, readableTail, symbolTail);
		}

		public EL3024_C6E76B5A(): base ()
		{
			PexPreConstructorParameterless();
			_AI_Standard_Channel_1 = new AI_Standard_Channel_4A394481();
			_AI_Standard_Channel_1.AttributeName = "AI_Standard_Channel_1";
			_AI_Standard_Channel_2 = new AI_Standard_Channel_4A394481();
			_AI_Standard_Channel_2.AttributeName = "AI_Standard_Channel_2";
			_AI_Standard_Channel_3 = new AI_Standard_Channel_4A394481();
			_AI_Standard_Channel_3.AttributeName = "AI_Standard_Channel_3";
			_AI_Standard_Channel_4 = new AI_Standard_Channel_4A394481();
			_AI_Standard_Channel_4.AttributeName = "AI_Standard_Channel_4";
            ...
            /// </summary>
            /// <exclude />
	public partial class PlainEL3024_C6E76B5A
	{
		public void CopyPlainToCyclic(Plc1.EL3024_C6E76B5A target)
		{
		...
		public void CopyPlainToCyclic(Plc1.IEL3024_C6E76B5A target)
		{
			this.CopyPlainToCyclic((Plc1.EL3024_C6E76B5A)target);
		}

		public void CopyPlainToShadow(Plc1.EL3024_C6E76B5A target)
		{
		...
		public void CopyPlainToShadow(Plc1.IShadowEL3024_C6E76B5A target)
		{
			this.CopyPlainToShadow((Plc1.EL3024_C6E76B5A)target);
		}

		public void CopyCyclicToPlain(Plc1.EL3024_C6E76B5A source)
		{
		...
		public void CopyCyclicToPlain(Plc1.IEL3024_C6E76B5A source)
		{
			this.CopyCyclicToPlain((Plc1.EL3024_C6E76B5A)source);
		}

		public void CopyShadowToPlain(Plc1.EL3024_C6E76B5A source)
		{
		...
		public void CopyShadowToPlain(Plc1.IShadowEL3024_C6E76B5A source)
		{
			this.CopyShadowToPlain((Plc1.EL3024_C6E76B5A)source);
		}
	}
}