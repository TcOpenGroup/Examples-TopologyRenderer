...
#pragma warning disable SA1402, CS1591, CS0108, CS0067
	[Vortex.Connector.Attributes.TypeMetaDescriptorAttribute("{attribute addProperty VendorId \"#x00000002\" } {attribute addProperty BoxType \"EL3164-0000-0020\" } {attribute addProperty Description \"EL3164 4Ch. Ana. Input 0-10V\" } {attribute addProperty Physics \"KK\" } {attribute addProperty Id \"AI_Standard_Channel_1AT %I*AI_Standard_Channel_A8DF64E310AI_Standard_Channel_2AT %I*AI_Standard_Channel_A8DF64E310AI_Standard_Channel_3AT %I*AI_Standard_Channel_A8DF64E310AI_Standard_Channel_4AT %I*AI_Standard_Channel_A8DF64E310WcStateAT %I*WcState_9091E0EB2InfoDataAT %I*InfoData_23CBA8372\" } {attribute addProperty CRC \"3072065346\" } {attribute addProperty Size \"44\" } {attribute addProperty Name \"\" }", "EL3164_B71BFF42", "Plc1", TypeComplexityEnum.Complex)]
	public partial class EL3164_B71BFF42 : TcoIo.EtcSlaveTerminalBase_947E5A46, Vortex.Connector.IVortexObject, IEL3164_B71BFF42, IShadowEL3164_B71BFF42, Vortex.Connector.IVortexOnlineObject, Vortex.Connector.IVortexShadowObject
	{
		...
		IAI_Standard_Channel_A8DF64E3 IEL3164_B71BFF42.AI_Standard_Channel_1
		{
			get
			{
		...
		IShadowAI_Standard_Channel_A8DF64E3 IShadowEL3164_B71BFF42.AI_Standard_Channel_1
		{
			get
			{
				return AI_Standard_Channel_1;
		...
		IAI_Standard_Channel_A8DF64E3 IEL3164_B71BFF42.AI_Standard_Channel_2
		{
			get
			{
		...
		IShadowAI_Standard_Channel_A8DF64E3 IShadowEL3164_B71BFF42.AI_Standard_Channel_2
		{
			get
			{
				return AI_Standard_Channel_2;
		...
		IAI_Standard_Channel_A8DF64E3 IEL3164_B71BFF42.AI_Standard_Channel_3
		{
			get
			{
		...
		IShadowAI_Standard_Channel_A8DF64E3 IShadowEL3164_B71BFF42.AI_Standard_Channel_3
		{
			get
			{
				return AI_Standard_Channel_3;
		...
		IAI_Standard_Channel_A8DF64E3 IEL3164_B71BFF42.AI_Standard_Channel_4
		{
			get
			{
		...
		IShadowAI_Standard_Channel_A8DF64E3 IShadowEL3164_B71BFF42.AI_Standard_Channel_4
		{
			get
			{
				return AI_Standard_Channel_4;
		...
		TcoIo.IWcState_9091E0EB IEL3164_B71BFF42.WcState
		{
			get
			{
				return WcState;
		...
		TcoIo.IShadowWcState_9091E0EB IShadowEL3164_B71BFF42.WcState
		{
			get
			{
				return WcState;
		...
		TcoIo.IInfoData_23CBA837 IEL3164_B71BFF42.InfoData
		{
			get
			{
				return InfoData;
		...
		TcoIo.IShadowInfoData_23CBA837 IShadowEL3164_B71BFF42.InfoData
		{
			get
			{
				return InfoData;
		...
		public new PlainEL3164_B71BFF42 CreatePlainerType()
		{
			var cloned = new PlainEL3164_B71BFF42();
		...
		protected PlainEL3164_B71BFF42 CreatePlainerType(PlainEL3164_B71BFF42 cloned)
		{
			base.CreatePlainerType(cloned);
			cloned.AI_Standard_Channel_1 = AI_Standard_Channel_1.CreatePlainerType();
			cloned.AI_Standard_Channel_2 = AI_Standard_Channel_2.CreatePlainerType();
		...
		public void FlushPlainToOnline(Plc1.PlainEL3164_B71BFF42 source)
		{
			source.CopyPlainToCyclic(this);
			this.Write();
		}

		public void CopyPlainToShadow(Plc1.PlainEL3164_B71BFF42 source)
		{
		...
		public void FlushOnlineToPlain(Plc1.PlainEL3164_B71BFF42 source)
		{
			this.Read();
		...
		public EL3164_B71BFF42(Vortex.Connector.IVortexObject parent, string readableTail, string symbolTail): base (parent, readableTail, symbolTail)
		{
			...
			AttributeBoxType = "EL3164-0000-0020";
			AttributeDescription = "EL3164 4Ch. Ana. Input 0-10V";
			AttributePhysics = "KK";
		...
		public EL3164_B71BFF42(): base ()
		{
            ...
            /// </summary>
            /// <exclude />
	public partial class PlainEL3164_B71BFF42
	{
		public void CopyPlainToCyclic(Plc1.EL3164_B71BFF42 target)
		{
		...
		public void CopyPlainToCyclic(Plc1.IEL3164_B71BFF42 target)
		{
			this.CopyPlainToCyclic((Plc1.EL3164_B71BFF42)target);
		}

		public void CopyPlainToShadow(Plc1.EL3164_B71BFF42 target)
		{
		...
		public void CopyPlainToShadow(Plc1.IShadowEL3164_B71BFF42 target)
		{
			this.CopyPlainToShadow((Plc1.EL3164_B71BFF42)target);
		}

		public void CopyCyclicToPlain(Plc1.EL3164_B71BFF42 source)
		{
		...
		public void CopyCyclicToPlain(Plc1.IEL3164_B71BFF42 source)
		{
			this.CopyCyclicToPlain((Plc1.EL3164_B71BFF42)source);
		}

		public void CopyShadowToPlain(Plc1.EL3164_B71BFF42 source)
		{
		...
		public void CopyShadowToPlain(Plc1.IShadowEL3164_B71BFF42 source)
		{
			this.CopyShadowToPlain((Plc1.EL3164_B71BFF42)source);
		}
	}
}