...
#pragma warning disable SA1402, CS1591, CS0108, CS0067
	[Vortex.Connector.Attributes.TypeMetaDescriptorAttribute("{attribute addProperty BoxType \"EL3773-0000-0021\" } {attribute addProperty Id \"ARRAY_0INT2ARRAY_1INT2ARRAY_2INT2ARRAY_3INT2ARRAY_4INT2ARRAY_5INT2ARRAY_6INT2ARRAY_7INT2ARRAY_8INT2ARRAY_9INT2\" } {attribute addProperty CRC \"625549959\" } {attribute addProperty Size \"20\" } {attribute addProperty Name \"\" }", "I2_Samples_25492287", "Plc1", TypeComplexityEnum.Complex)]
	public partial class I2_Samples_25492287 : Vortex.Connector.IVortexObject, II2_Samples_25492287, IShadowI2_Samples_25492287, Vortex.Connector.IVortexOnlineObject, Vortex.Connector.IVortexShadowObject
	{
		...
		Vortex.Connector.ValueTypes.Online.IOnlineInt II2_Samples_25492287.ARRAY_0
		{
			get
			{
				return ARRAY_0;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowInt IShadowI2_Samples_25492287.ARRAY_0
		{
			get
			{
				return ARRAY_0;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineInt II2_Samples_25492287.ARRAY_1
		{
			get
			{
				return ARRAY_1;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowInt IShadowI2_Samples_25492287.ARRAY_1
		{
			get
			{
				return ARRAY_1;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineInt II2_Samples_25492287.ARRAY_2
		{
			get
			{
				return ARRAY_2;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowInt IShadowI2_Samples_25492287.ARRAY_2
		{
			get
			{
				return ARRAY_2;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineInt II2_Samples_25492287.ARRAY_3
		{
			get
			{
				return ARRAY_3;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowInt IShadowI2_Samples_25492287.ARRAY_3
		{
			get
			{
				return ARRAY_3;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineInt II2_Samples_25492287.ARRAY_4
		{
			get
			{
				return ARRAY_4;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowInt IShadowI2_Samples_25492287.ARRAY_4
		{
			get
			{
				return ARRAY_4;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineInt II2_Samples_25492287.ARRAY_5
		{
			get
			{
				return ARRAY_5;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowInt IShadowI2_Samples_25492287.ARRAY_5
		{
			get
			{
				return ARRAY_5;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineInt II2_Samples_25492287.ARRAY_6
		{
			get
			{
				return ARRAY_6;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowInt IShadowI2_Samples_25492287.ARRAY_6
		{
			get
			{
				return ARRAY_6;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineInt II2_Samples_25492287.ARRAY_7
		{
			get
			{
				return ARRAY_7;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowInt IShadowI2_Samples_25492287.ARRAY_7
		{
			get
			{
				return ARRAY_7;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineInt II2_Samples_25492287.ARRAY_8
		{
			get
			{
				return ARRAY_8;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowInt IShadowI2_Samples_25492287.ARRAY_8
		{
			get
			{
				return ARRAY_8;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineInt II2_Samples_25492287.ARRAY_9
		{
			get
			{
				return ARRAY_9;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowInt IShadowI2_Samples_25492287.ARRAY_9
		{
			get
			{
				return ARRAY_9;
		...
		public PlainI2_Samples_25492287 CreatePlainerType()
		{
			var cloned = new PlainI2_Samples_25492287();
			return cloned;
		}

		protected PlainI2_Samples_25492287 CreatePlainerType(PlainI2_Samples_25492287 cloned)
		{
			return cloned;
		}
		...
		public void FlushPlainToOnline(Plc1.PlainI2_Samples_25492287 source)
		{
			source.CopyPlainToCyclic(this);
			this.Write();
		}

		public void CopyPlainToShadow(Plc1.PlainI2_Samples_25492287 source)
		{
		...
		public void FlushOnlineToPlain(Plc1.PlainI2_Samples_25492287 source)
		{
			this.Read();
		...
		public I2_Samples_25492287(Vortex.Connector.IVortexObject parent, string readableTail, string symbolTail)
		{
		...
		public I2_Samples_25492287()
		{
            ...
            /// </summary>
            /// <exclude />
	public partial class PlainI2_Samples_25492287
	{
		public void CopyPlainToCyclic(Plc1.I2_Samples_25492287 target)
		{
		...
		public void CopyPlainToCyclic(Plc1.II2_Samples_25492287 target)
		{
			this.CopyPlainToCyclic((Plc1.I2_Samples_25492287)target);
		}

		public void CopyPlainToShadow(Plc1.I2_Samples_25492287 target)
		{
		...
		public void CopyPlainToShadow(Plc1.IShadowI2_Samples_25492287 target)
		{
			this.CopyPlainToShadow((Plc1.I2_Samples_25492287)target);
		}

		public void CopyCyclicToPlain(Plc1.I2_Samples_25492287 source)
		{
		...
		public void CopyCyclicToPlain(Plc1.II2_Samples_25492287 source)
		{
			this.CopyCyclicToPlain((Plc1.I2_Samples_25492287)source);
		}

		public void CopyShadowToPlain(Plc1.I2_Samples_25492287 source)
		{
		...
		public void CopyShadowToPlain(Plc1.IShadowI2_Samples_25492287 source)
		{
			this.CopyShadowToPlain((Plc1.I2_Samples_25492287)source);
		}
	}
}