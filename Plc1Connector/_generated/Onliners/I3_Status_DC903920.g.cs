...
#pragma warning disable SA1402, CS1591, CS0108, CS0067
	[Vortex.Connector.Attributes.TypeMetaDescriptorAttribute("{attribute addProperty BoxType \"EL3773-0000-0021\" } {attribute addProperty Id \"UnderrangeBOOL1OverrangeBOOL1Limit_xBYTE1ErrorBOOL1Sync_errorBOOL1TxPDO_StateBOOL1TxPDO_ToggleBOOL1\" } {attribute addProperty CRC \"3700439328\" } {attribute addProperty Size \"7\" } {attribute addProperty Name \"\" }", "I3_Status_DC903920", "Plc1", TypeComplexityEnum.Complex)]
	public partial class I3_Status_DC903920 : Vortex.Connector.IVortexObject, II3_Status_DC903920, IShadowI3_Status_DC903920, Vortex.Connector.IVortexOnlineObject, Vortex.Connector.IVortexShadowObject
	{
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool II3_Status_DC903920.Underrange
		{
			get
			{
				return Underrange;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowI3_Status_DC903920.Underrange
		{
			get
			{
				return Underrange;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool II3_Status_DC903920.Overrange
		{
			get
			{
				return Overrange;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowI3_Status_DC903920.Overrange
		{
			get
			{
				return Overrange;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineByte II3_Status_DC903920.Limit_x
		{
			get
			{
				return Limit_x;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowByte IShadowI3_Status_DC903920.Limit_x
		{
			get
			{
				return Limit_x;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool II3_Status_DC903920.Error
		{
			get
			{
				return Error;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowI3_Status_DC903920.Error
		{
			get
			{
				return Error;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool II3_Status_DC903920.Sync_error
		{
			get
			{
				return Sync_error;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowI3_Status_DC903920.Sync_error
		{
			get
			{
				return Sync_error;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool II3_Status_DC903920.TxPDO_State
		{
			get
			{
				return TxPDO_State;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowI3_Status_DC903920.TxPDO_State
		{
			get
			{
				return TxPDO_State;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool II3_Status_DC903920.TxPDO_Toggle
		{
			get
			{
				return TxPDO_Toggle;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowI3_Status_DC903920.TxPDO_Toggle
		{
			get
			{
				return TxPDO_Toggle;
		...
		public PlainI3_Status_DC903920 CreatePlainerType()
		{
			var cloned = new PlainI3_Status_DC903920();
			return cloned;
		}

		protected PlainI3_Status_DC903920 CreatePlainerType(PlainI3_Status_DC903920 cloned)
		{
			return cloned;
		}
		...
		public void FlushPlainToOnline(Plc1.PlainI3_Status_DC903920 source)
		{
			source.CopyPlainToCyclic(this);
			this.Write();
		}

		public void CopyPlainToShadow(Plc1.PlainI3_Status_DC903920 source)
		{
		...
		public void FlushOnlineToPlain(Plc1.PlainI3_Status_DC903920 source)
		{
			this.Read();
		...
		public I3_Status_DC903920(Vortex.Connector.IVortexObject parent, string readableTail, string symbolTail)
		{
		...
		public I3_Status_DC903920()
		{
            ...
            /// </summary>
            /// <exclude />
	public partial class PlainI3_Status_DC903920
	{
		public void CopyPlainToCyclic(Plc1.I3_Status_DC903920 target)
		{
		...
		public void CopyPlainToCyclic(Plc1.II3_Status_DC903920 target)
		{
			this.CopyPlainToCyclic((Plc1.I3_Status_DC903920)target);
		}

		public void CopyPlainToShadow(Plc1.I3_Status_DC903920 target)
		{
		...
		public void CopyPlainToShadow(Plc1.IShadowI3_Status_DC903920 target)
		{
			this.CopyPlainToShadow((Plc1.I3_Status_DC903920)target);
		}

		public void CopyCyclicToPlain(Plc1.I3_Status_DC903920 source)
		{
		...
		public void CopyCyclicToPlain(Plc1.II3_Status_DC903920 source)
		{
			this.CopyCyclicToPlain((Plc1.I3_Status_DC903920)source);
		}

		public void CopyShadowToPlain(Plc1.I3_Status_DC903920 source)
		{
		...
		public void CopyShadowToPlain(Plc1.IShadowI3_Status_DC903920 source)
		{
			this.CopyShadowToPlain((Plc1.I3_Status_DC903920)source);
		}
	}
}