...
#pragma warning disable SA1402, CS1591, CS0108, CS0067
	[Vortex.Connector.Attributes.TypeMetaDescriptorAttribute("{attribute addProperty BoxType \"EL3773-0000-0021\" } {attribute addProperty Id \"UnderrangeBOOL1OverrangeBOOL1Limit_xBYTE1ErrorBOOL1Sync_errorBOOL1TxPDO_StateBOOL1TxPDO_ToggleBOOL1\" } {attribute addProperty CRC \"3700439328\" } {attribute addProperty Size \"7\" } {attribute addProperty Name \"\" }", "U1_Status_DC903920", "Plc1", TypeComplexityEnum.Complex)]
	public partial class U1_Status_DC903920 : Vortex.Connector.IVortexObject, IU1_Status_DC903920, IShadowU1_Status_DC903920, Vortex.Connector.IVortexOnlineObject, Vortex.Connector.IVortexShadowObject
	{
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool IU1_Status_DC903920.Underrange
		{
			get
			{
				return Underrange;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowU1_Status_DC903920.Underrange
		{
			get
			{
				return Underrange;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool IU1_Status_DC903920.Overrange
		{
			get
			{
				return Overrange;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowU1_Status_DC903920.Overrange
		{
			get
			{
				return Overrange;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineByte IU1_Status_DC903920.Limit_x
		{
			get
			{
				return Limit_x;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowByte IShadowU1_Status_DC903920.Limit_x
		{
			get
			{
				return Limit_x;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool IU1_Status_DC903920.Error
		{
			get
			{
				return Error;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowU1_Status_DC903920.Error
		{
			get
			{
				return Error;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool IU1_Status_DC903920.Sync_error
		{
			get
			{
				return Sync_error;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowU1_Status_DC903920.Sync_error
		{
			get
			{
				return Sync_error;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool IU1_Status_DC903920.TxPDO_State
		{
			get
			{
				return TxPDO_State;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowU1_Status_DC903920.TxPDO_State
		{
			get
			{
				return TxPDO_State;
		...
		Vortex.Connector.ValueTypes.Online.IOnlineBool IU1_Status_DC903920.TxPDO_Toggle
		{
			get
			{
				return TxPDO_Toggle;
		...
		Vortex.Connector.ValueTypes.Shadows.IShadowBool IShadowU1_Status_DC903920.TxPDO_Toggle
		{
			get
			{
				return TxPDO_Toggle;
		...
		public PlainU1_Status_DC903920 CreatePlainerType()
		{
			var cloned = new PlainU1_Status_DC903920();
			return cloned;
		}

		protected PlainU1_Status_DC903920 CreatePlainerType(PlainU1_Status_DC903920 cloned)
		{
			return cloned;
		}
		...
		public void FlushPlainToOnline(Plc1.PlainU1_Status_DC903920 source)
		{
			source.CopyPlainToCyclic(this);
			this.Write();
		}

		public void CopyPlainToShadow(Plc1.PlainU1_Status_DC903920 source)
		{
		...
		public void FlushOnlineToPlain(Plc1.PlainU1_Status_DC903920 source)
		{
			this.Read();
		...
		public U1_Status_DC903920(Vortex.Connector.IVortexObject parent, string readableTail, string symbolTail)
		{
		...
		public U1_Status_DC903920()
		{
            ...
            /// </summary>
            /// <exclude />
	public partial class PlainU1_Status_DC903920
	{
		public void CopyPlainToCyclic(Plc1.U1_Status_DC903920 target)
		{
		...
		public void CopyPlainToCyclic(Plc1.IU1_Status_DC903920 target)
		{
			this.CopyPlainToCyclic((Plc1.U1_Status_DC903920)target);
		}

		public void CopyPlainToShadow(Plc1.U1_Status_DC903920 target)
		{
		...
		public void CopyPlainToShadow(Plc1.IShadowU1_Status_DC903920 target)
		{
			this.CopyPlainToShadow((Plc1.U1_Status_DC903920)target);
		}

		public void CopyCyclicToPlain(Plc1.U1_Status_DC903920 source)
		{
		...
		public void CopyCyclicToPlain(Plc1.IU1_Status_DC903920 source)
		{
			this.CopyCyclicToPlain((Plc1.U1_Status_DC903920)source);
		}

		public void CopyShadowToPlain(Plc1.U1_Status_DC903920 source)
		{
		...
		public void CopyShadowToPlain(Plc1.IShadowU1_Status_DC903920 source)
		{
			this.CopyShadowToPlain((Plc1.U1_Status_DC903920)source);
		}
	}
}